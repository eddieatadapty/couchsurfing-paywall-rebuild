...
server required. Two tabs: the clickable prototype with a per-screen rationale panel,
and a before/after sequence with the ranked change table.
...
| 6 | Q5 What earns a yes | NEW | education screen, offer paywall's second line |
| 7 | **How trust works** | NEW | answers the Q5 objection with the real mechanism |
| 8 | **How a stay happens** | NEW | removes the "why am I paying to sleep somewhere" objection |
| 9 | Loader | NEW | shows all five answers being consumed |
| 10 | Payoff | NEW | published host count for the chosen city |
| 11 | Membership paywall | KEPT | — |
| 12 | Offer paywall on close | NEW | fires on ✕ **and** "Not Now" |
| 13 | Location + sign-up | MOVED | — |
...
| 6 | High | Educational content / method explanation | CR +5–15% |
| 7 | High | Free vs paid comparison | CR +10–20% · ARPU +3–8% |
| 8 | Medium | Annual savings visualization | CR +5–15% · ARPU +10–15% |
| 9 | Medium | Permissions timing · registration friction | CR +10–15% · CR +8%, ARPU +17% |
| 10 | Medium | Trust signals near CTA | CR +3–8% |
...
- **Member and city counts** — Couchsurfing Help Centre, *How Does Couchsurfing Work?*
  (11 Aug 2026): "more than 25 million Members in over 200,000 cities". **The App Store
  description still says 12 million / 230,000 cities** — the two disagree; the screens use
  the newer pair.
- **Trust mechanics, the stay sequence, what membership unlocks, and "Hosts are not paid"**
  — Couchsurfing Help Centre, *How Does Couchsurfing Work?* and *What Are References and
  How Do They Work?*
...
1. ~~**A free-vs-paid comparison table**~~ — **since built.** Originally ruled out because
   the free tier's limits were not published anywhere verifiable. The Help Centre answers it
   directly: membership "unlocks the ability to find stays, host Travelers, join Events,
   participate in Communities, and use Hangouts." Now on the paywall, five rows, nothing guessed.
...
1. **Your two member counts disagree.** App Store says 12M members / 230,000 cities; the
   Help Centre (Aug 2026) says 25M members / 200,000+ cities. The store listing looks stale.
